...
export const CurrentInvestorsList = () => {
    document.title = "Current Investors | Venture Studio"

    //BreadCrumb
    const items = [
        {
            label: 'InputText',
            template: () => <span className="p-breadcrumb-item active">Current Investors</span>
        }
    ];
    ...
    const getInvestorsDataFromAPI = async () => {
        ...
        // Api call
        pageService
            .getClientsList(status.code, "currentinvestor", localStorage.getItem("user_type") == "broker" ? localStorage.getItem("id") : null)
            .then((response) => {
                // Get response
                if (response) {
                    const DataList = response;
    ...
    const fullNameTemplate = (rowData: any, rowIndex: any) => {
        return (
            <>
                <Link className="tb-avatar-box" to="/current-investor-details" state={{ investor_id: rowData.id }}>{rowData?.profile_img != null && rowData?.profile_img != "null" && rowData?.profile_img != "" ?
    ...
    const addUpdateClient = () => {
        ...
        if (!isError) {
            ...
            formData.append('user_type', "currentinvestor");
            ...
            <div className="page-header">
                <div className="page-leftheader">
                    <div className="page-header-info">
                        <div className="page-title">Current Investors</div>
