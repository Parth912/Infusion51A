...
import { CListColumns } from '../../../appconfig/DatatableSetting';
...
export const CList = () => {
    document.title = "Client | Venture Studio"
    ...
    // This is Date Creation Template
